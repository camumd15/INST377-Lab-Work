(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[15],{"/656":function(e,t,n){"use strict"
...
while(v>=0){d=s[v]
if(d.length>0)break
v--}if(d){var f=String(d.slice(-1));-1!==r.indexOf(f)&&(s[v].length-=1)}}}l()
c=s[o]
if(c){var p=c[h+1]
...
if(g.length>0)break
_++}if(g){var m=String(g[0]);-1!==r.indexOf(m)&&s[_].shift()}}}}else{l()
var b=s[o]
if(b){var x=b[h-1]
...
for(var l=0;l<this._nodeMap.length;l++){var c=this._nodeMap[l]
"word"===n&&" "===c.data[c.data.length-1]&&(c.data.length-=1)
h[l]=c.data
for(var u=0;u<c.data.length;u++)o.push(l)}this._defaultStringData=k(h)
...
var c=""
for(var u=0;u<l.length;u++){var d=l[u]
c+=" ".concat(d.nodeName,'="').concat(d.nodeValue,'"')}n+="<".concat(h).concat(c,">").concat(o,"</").concat(h,">")}else 3===i.node.nodeType&&(n+=o)}return n}},{key:"checkFit",value:function(e){var t=this.domString(e)
...
c=k(this._defaultStringData)
h=r?0:this._nodeDataIndexes.length-1
while(!s){if(h<0)break
if(r){var d=this.getNodeIndexes(c)
var v=Math.floor(d.length/2)
u=d[v]
h>0&&c[u[0]].splice(u[1],1,t)}else{o=this._nodeDataIndexes[h]
if(h<this._nodeDataIndexes.length-1){c[o]=c[o].slice(0,-1)
c[o].push(t)}}s=this.checkFit(c)
if(s){for(var f=0;f<c.length;f++){var p=c[f]
l+=p.join("")}break}i=true
if(r){c[u[0]].splice(u[1],1)
h++}else{c[o]=c[o].slice(0,-1)
h--}}c=U(c,this._options,true)
if(i&&!r){l=N(l.split(t)[0],n,false,true,true)
l+=t}else if(i&&r){var g=l.split(t)
l=N(g[0],n,false,true,true)+t+N(g[1],n,true,false,true)}return{isTruncated:i,text:l,data:c,constraints:{width:this._maxWidth,height:this._maxHeight,lines:this._maxLines}}}}])
return e}()
var X=W
...
var P=(R=Object(O["a"])(),B=Object(p["l"])(z,Q),J=b(["shouldTruncateWhenInvisible"]),R(K=B(K=J(K=(A=q=function(e){Object(o["a"])(n,e)
var t=Object(h["a"])(n)
function n(e){var a
Object(i["a"])(this,n)
a=t.call(this,e)
...
var o=i.join("")
s&&s.props?a.push(Object(y["a"])(s,s.props,o)):a.push(o)}a.push(c.a.createElement("span",{className:Q.spacer,style:{width:n||null}}))
var h=c.a.Children.map(a,(function(e){return e}))
