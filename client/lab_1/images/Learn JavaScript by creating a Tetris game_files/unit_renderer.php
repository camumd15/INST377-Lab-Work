...
if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_620ea6d5cfae1"];
}else{
	jvxObjectList.push("jvx_620ea6d5cfae1");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=22&bDim=300x600&bUnitId=2200&siteId=0618ae7170817d&campaignId=155608&es_pId=4452At&isDynamic=1&ap_DataSignal8=319766058&ap_DataSignal9=161302879&us_privacy=${US_PRIVACY}&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https://adclick.g.doubleclick.net/pcs/click%3Fxai%3DAKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw%26sai%3DAMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU%26sig%3DCg0ArKJSzNT3pG00rtR8EAE%26cry%3D1%26fbs_aeid%3D%5Bgw_fbsaeid%5D%26urlfix%3D1%26adurl%3D&r=1482827617") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function createiFrameNode(obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_620ea6d5cfae1' style='display:none;'></div>")
	}
/*
JavaScript responsible for frame busting
*/
var jvx_620ea6d5cfae1TraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_620ea6d5cfae1SafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_620ea6d5cfae1CanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_620ea6d5cfae1InNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_620ea6d5cfae1TraffickedInFrame = true;
}

try{
		$sf.ext.register(300, 600);
		jvx_620ea6d5cfae1SafeFrameSupported = true;
}catch(e){
	jvx_620ea6d5cfae1SafeFrameSupported = false;
}
...
var adViewabilityDetectInit = function (visibilityThreshold) { 
    try {
        ...
        boxElement = document.querySelector('#adUnitContainer_620ea6d5cfae1');
                    ...
                    if (!adInVPForOneSec && !timerRunning) {
                        ...
                        timeoutHandle = setTimeout(function () {
                            adInVPForOneSec = true;
                                                        if(typeof jvx_620ea6d5cfae1 != "undefined")
                            jvx_620ea6d5cfae1.recordEvent(73);
                            else 
                            recordEvent(73);
                                                    }, 1000);
                    }
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_620ea6d5cfae1'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_620ea6d5cfae1.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_620ea6d5cfae1.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
								//Remove bg image div once base layout iframe is loaded
				//jvx_620ea6d5cfae1.hideBaseBg();
							} else if(msg == 'recordUIR'){
				jvx_620ea6d5cfae1.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_620ea6d5cfae1.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_620ea6d5cfae1.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_620ea6d5cfae1.DwellRecorded){
					jvx_620ea6d5cfae1.recordDwellEvent(49, jvx_620ea6d5cfae1.DwellElapsedTime);
				}
			}
									else if(msg=="dynamicProperties") {
                jvx_620ea6d5cfae1.updateDYProperties(s[2],1);
							}
			else if(msg=="clickThroughUrl") { 
								jvx_620ea6d5cfae1.clickTagURL = s.slice(2).flat(1).join(":");
			}
			else if(msg == "clickTrackers") {	
								jvx_620ea6d5cfae1.clickTrackers =  s.slice(2).join(":").split(",").map(function(url){ return decodeURIComponent(url) });
				this.clickTrackers = jvx_620ea6d5cfae1.clickTrackers;
			}
												                        else if(msg == "miniScrollerBgInfo"){
                var miniScrollerBgURL = decodeURIComponent(s[2]);
                jvx_620ea6d5cfae1.fixedBgAstLeft = parseInt(s[3]);
                jvx_620ea6d5cfae1.renderFixedPageBg(miniScrollerBgURL,s[3]);
            } 
		}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_620ea6d5cfae1' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_620ea6d5cfae1' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
        ...
        if(jvx_620ea6d5cfae1TraffickedInFrame){
                        try{
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_620ea6d5cfae1 != 'undefined' && url.match("http://evs.jivox.com/jivox/serverAPIs/saveImpression.php")){	//Add es_cgName and es_segName params only for the evs trackers URL not for the thirdParty trackers.
				finalURL += "&es_cgName_"+jvx_620ea6d5cfae1.DYReportingKey;
                if(jvx_620ea6d5cfae1.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_620ea6d5cfae1.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_620ea6d5cfae1.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_620ea6d5cfae1SafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_620ea6d5cfae1,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_620ea6d5cfae1.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_620ea6d5cfae1.baseContainerId)){
				return; 
			}
		jvx_620ea6d5cfae1.init();
	...
	function handleMraidViewableImprFiring(){
		if (!adInVPForOneSec && !timerRunning) {
			...
			var timeoutHandle = setTimeout(function () {
				adInVPForOneSec = true;
				jvx_620ea6d5cfae1.recordEvent(74);
			}, 1000);
		}
	}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","creativeUnitType":"22","bDim":"300x600","bUnitId":"2200","siteId":"0618ae7170817d","campaignId":"155608","es_pId":"4452At","isDynamic":"1","ap_DataSignal8":"319766058","ap_DataSignal9":"161302879","us_privacy":"${US_PRIVACY}","gdpr":"","gdpr_consent":"","jvxVer":"2","cMacro":"https:\/\/adclick.g.doubleclick.net\/pcs\/click?xai=AKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw&sai=AMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU&sig=Cg0ArKJSzNT3pG00rtR8EAE&cry=1&fbs_aeid=[gw_fbsaeid]&urlfix=1&adurl=","r":"1482827617","0":"","serverURL":"https:\/\/as.jivox.com","delayLoad":"2"};
		this.campaignId = '155608';
		this.siteId = '0618ae7170817d';
		this.placementId = '4452At';
		...
		this.asyncCompletedTaskCount = 0;
											this.asyncTaskList['delay-load'] = 0;
			this.asyncTaskCount++;
		
                				this.browserName = 'Chrome';
		this.browserVersion = '97.0.4692.99';
								this.clickTagURL = 'https://adclick.g.doubleclick.net/pcs/click?xai=AKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw&sai=AMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU&sig=Cg0ArKJSzNT3pG00rtR8EAE&cry=1&fbs_aeid=[gw_fbsaeid]&urlfix=1&adurl=https%3A%2F%2Fathleta.gap.com%2F';
		this.clickTrackers = [];
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=22&bDim=300x600&bUnitId=2200&siteId=0618ae7170817d&campaignId=155608&es_pId=4452At&isDynamic=1&ap_DataSignal8=319766058&ap_DataSignal9=161302879&us_privacy=%24%7BUS_PRIVACY%7D&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%3Fxai%3DAKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw%26sai%3DAMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU%26sig%3DCg0ArKJSzNT3pG00rtR8EAE%26cry%3D1%26fbs_aeid%3D%5Bgw_fbsaeid%5D%26urlfix%3D1%26adurl%3D&r=1482827617&objectName=jvx_620ea6d5cfae1&adUnitId=2200&jvxSessionId=1645127381.8694&delayLoad=0';
        			this.baseURL += '&base=1';
            this.baseURL += '&creativeResolveBeginTime='+Date.parse(creativeResolveBeginTime);
            		        this.baseBgType = 'image';
		this.baseBgURL = 'https://assets.jivox.com/assets/asset/2021/11/70685-0-aim61893fc572efb.png';
		this.baseBgColor = '';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_620ea6d5cfae1SafeFrameSupported){
		         var callBackFnName ='jvx_620ea6d5cfae1'+".updateDYProperties";
		         jvx_620ea6d5cfae1.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_620ea6d5cfae1.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_620ea6d5cfae1.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
            //this.fireCREvent();
         },
			...
			if(doFireCreativeLoadEvt){
				...
				jvx_620ea6d5cfae1.recordEvent(72, 'es_et=' + creativeLoadElapseTime);
			}
		},
                    ...
                    if(jvx_620ea6d5cfae1SafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_620ea6d5cfae1.sendCookieRequest('jvx_620ea6d5cfae1'+"_dynamicProperties");
                            }
                    }
                												if(eventSrc.id == this.baseId){
					this.hideBaseBg();
				}
							}	
		},
		...
		*/
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_620ea6d5cfae1SafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		renderInterceptor:function(type){
			...
			this.applyInterceptorStyle(iNode,pNode);
						...
						renderBaseBg:function(){
			var bNode = createDivNode(this.baseBgId), //bg image for delayLoad and clickToLoad
				pNode = getElById(this.baseContainerId);
			bNode.style.width = this.baseWidth + "px";
			bNode.style.height = this.baseHeight + "px";
						bNode.style.position = "absolute";
			bNode.style.top = "0px";
			bNode.style.left = "0px";
						bNode.style.opacity = "1";
			pNode.appendChild(bNode);
			bNode.style.background = this.baseBgColor + " url('" + this.baseBgURL + "') no-repeat";
		},
		hideBaseBg:function(){
			var bNode = getElById(this.baseBgId);
			var b2Node = getElById(this.baseBg2Id);
			//Reduce opacity of bg image div so that unit iframe is visible
			var browserPrefix = getBrowserPrefix(this.browserName);
			var browserPrefixTransParam = "-" + browserPrefix + "-transition",
				transStr =  '0.5s ease-in-out';
			var elemAttrStyle = {
				'transition'	: transStr,
				'opacity'		: '0'
			};
			elemAttrStyle[browserPrefixTransParam] = transStr;
			addStyles(bNode, elemAttrStyle);
			if(b2Node)
				addStyles(b2Node, elemAttrStyle);
			//Remove bg image div once base layout iframe is loaded
			setTimeout(function() { 
							if(bNode)
								removeNode(bNode); 
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_620ea6d5cfae1"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openClickThrough:function(){
				...
				openExpansion:function(autoExpand, skipOpenEvent){
						...
						if(!jvx_620ea6d5cfae1CanBustFromFrame || jvx_620ea6d5cfae1InNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
				...
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "155608/0618ae7170817d/22/jvxSId_1645127381.8694";
                eventReportingURL += "/es_pId_4452At";
                tempURL += "";
                                tempURL += "/ap_DataSignal8=319766058/ap_DataSignal9=161302879";
                                tempURL = addnlParams ? (tempURL + "/" + addnlParams) : tempURL;
				tempURL = tempURL + "/jvxRandom=" + rand;
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://adclick.g.doubleclick.net/pcs/click?xai=AKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw&sai=AMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU&sig=Cg0ArKJSzNT3pG00rtR8EAE&cry=1&fbs_aeid=[gw_fbsaeid]&urlfix=1&adurl=https%3A%2F%2Fathleta.gap.com%2F") : eventReportingURL;
									tempURL += "/es_cgName="+jvx_620ea6d5cfae1.DYReportingKey;
                    if(jvx_620ea6d5cfae1.DYSegmentName != ""){
                        tempURL += "/es_segName="+jvx_620ea6d5cfae1.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_620ea6d5cfae1" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_620ea6d5cfae1");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=22&bDim=300x600&bUnitId=2200&siteId=0618ae7170817d&campaignId=155608&es_pId=4452At&isDynamic=1&ap_DataSignal8=319766058&ap_DataSignal9=161302879&us_privacy=%24%7BUS_PRIVACY%7D&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%3Fxai%3DAKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw%26sai%3DAMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU%26sig%3DCg0ArKJSzNT3pG00rtR8EAE%26cry%3D1%26fbs_aeid%3D%5Bgw_fbsaeid%5D%26urlfix%3D1%26adurl%3D&r=1482827617&objectName=jvx_620ea6d5cfae1';
											this.baseURL += '&jvxSessionId=1645127381.8694';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=22&bDim=300x600&&siteId=0618ae7170817d&campaignId=155608&es_pId=4452At&isDynamic=1&ap_DataSignal8=319766058&ap_DataSignal9=161302879&us_privacy=%24%7BUS_PRIVACY%7D&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%3Fxai%3DAKAOjss7C7amzkHnRbSP_YvipIobQLBlwWTZYo3ReDZOds_A4ZFpIbhSR7Jy1Gap4oHzKdfSwIpAsEsOBDnNCi8bqb6vjbMqW4R2ohWMjpAdqNn7qj1SvlHk97uw8_s_EIYifdRzRj6ohFDY6EAG-6qWFz1g7XnJVXr18Z5KPUmIVgNGXedzfEd6KOmfwu4Lm_AmvICBuW2r_7UK8My2pGYnQ4IFugetMtJaZlPxkYxEKJui9Uy0faPnEoHcIl2r6BrYrw3dd5z2TDKG3D40rpI7pw_8EhG5K8geBwItIQbMk_XsNEAABH-ddyjR0vuUjzWH_y4nr6H0II-os6_t1qTe6bBp_2Fk7p0eQatVP7riX2tjnlYXnPO3t7gaXciNMq3CfQzVCJfzbzZMr_dpX9xDLf7BUju3UCri8AEcswWmSW3Q_ohvXw50gfqHyrmkVxZITxSSth32lxdb24XLEJOWmT1uMG76NcgkLAlFiWFasW2Pl0d7mpxwKo24fqpt8VdblZGVOiWvgKkw08Un9V6PqNCqD7m3G9Er_3lJjRXGSTO4rzaBjcHxmrCIdRWliBS4xRhAlfnPPB7JLs6-oT1UN5hH160RJi3O-RyDGWqH_mP3v2ujMEAIUfY8zUjCgKTgJwGdAYhpfuJHE2u5Bejz8BeATDg-b414_rioJq2OZ1-f8ZPur97AWBMJUNBS0CNlnvdErT-joRR1PJ9aB8rW1_Nx-4KlovQ8855qEu7Jz7Fzo1vK2nQYezGkO8ncdkgBjnGUN2UU5bxFjkMEeHQ_mx9Xfw2JACIpmAtPtIKY-ue1pSGCI9FhlEBUJGNBc99BtQXuKygs7YIKEMtJRCrfTItnlfQaGPnW7H8xVavYO6kJzvfhcQjPH4Lii4xxkawE-K5f-S_NtTeg_41cWpZc7UvQ73_btSqqOWcPAoLfLqFCNSSVi9ziESBKRCw8DKVXQ9SQAn6IYRJQInQSVsWIPw7u8la6xO2KUluQ2jbUtlDlDIXVjsSSyVeQ-G7T1ohKT8A-VHGlUWySsWjKzEJnBSqWoPG347mTC0F7Bqw6KPwVHCUJmxQD-HaQiczUVPbpTzJz0bGcwEApBHVIXsocAdRa8osLKjfLdwyissp8SjnNjGvY59--HR6y5PG8rtJO_o3whW2JIBTabMToakBDK2s5eQJm-e1DeWWaQtrajXnBIOCMI0GsI1t1kXp5Ys9euvkksNUrNdC05eo8NkpKEZWS5N6_80nErMbDltSxyzyhSTI2paGbKzjRNdLGD9g7zKBSRwPblndifPPwTw%26sai%3DAMfl-YTYt3jmhZwUaboTk4O1IJ2icnSowiEWK6C7WDav0sThnZwtOe1SPK4LaztVFVYrRdpUtPIkMTKk5vmSpQjILbeRoEBT_r0_icTQq8OBrRunXTaZyDfdPh2444qq3txLOrOtAmCkOWm0QXFfJbiQSjQpWEf7cVS1SiPUDlycu0PtEqgY-92roocSr_ECJml00pCmXbEOaYx5L3k-OfP2PN7AwYBNHEw4w7iIQM3be3SPeCFam6_RDMb9i7jW3aAheuZOKqW_ApW_mgyKV8g_vE09-pMA9CLNF7AAQIaeFPOPhvlv0CUZBFZELVWb8-V7JbJ3qPDZlyIksyaOMN9dbFF5Y0R3ue8R8N_V-VfLky7J671jTdFgYzkB0vnFt_ncMeU%26sig%3DCg0ArKJSzNT3pG00rtR8EAE%26cry%3D1%26fbs_aeid%3D%5Bgw_fbsaeid%5D%26urlfix%3D1%26adurl%3D&r=1482827617&objectName=jvx_620ea6d5cfae1'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1645127381.8694';
		...
		listenerCallback:function(event) {
			jvx_620ea6d5cfae1.eventController(event); 
		},
		...
		autoExpand:function(){
            ...
            this.autoExpandTimerRef = setTimeout(function(){self.closeExpansion(true);},7 * 1000);
						...
						this.renderAdUnitContainer(); 
										...
										var that = this;
					setTimeout(function(){
								that.asyncTaskList['delay-load'] = 1;
								that.asyncCompletedTaskCount++;
								that.renderBase();
															}, '2000');	
...
var jvx_620ea6d5cfae1 = new CreativeUnit("_620ea6d5cfae1");
jvx_620ea6d5cfae1.DYReportingKey = "";
jvx_620ea6d5cfae1.DYSegmentName = "";
	if(NonMraidTagInMraidEnv){
				jvx_620ea6d5cfae1.recordEvent(75);
	}
    jvx_620ea6d5cfae1.init();
