(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[49],{"+yat":function(e,t,n){"use strict"
n.d(t,"c",(function(){return c}))
n.d(t,"b",(function(){return s}))
n.d(t,"a",(function(){return r}))
n.d(t,"d",(function(){return i}))
var o=n("xvQv")
function c(e,t){const n=(""+e).trim().toLowerCase()
return t.findIndex(e=>e[0].toLowerCase()===n)}function s(e,t){const n=c(e,t)
if(-1===n)return null
if(0===n)return 100
const s=t[n][1]
const r=t[n-1][1]
const i=100*Object(o["a"])(r-s,4)
let l=1
i<=1&&(l=i<=.1?.01:.1)
return Object(o["a"])(100*r-l,2)}function r(e,t){const n=c(e,t)
if(-1===n)return null
const s=t[n][1]
...
return s[0]}},"3vji":function(e,t,n){"use strict"
...
return/%/g.test(e)}function x(e){return"EX"===e}function v(e,t){if(null==e||""===e)return e
if(null==t||""===t)return e
const n={precision:2,strip_insignificant_zeros:true}
let o=b
null!=e&&(o=s.n(e,n))
const c=s.n(t,n)
return s.t("%{score}/%{pointsPossibleTranslated}",{pointsPossibleTranslated:c,score:o})}function P(e){if(m.includes(e))return"complete"
if(_.includes(e))return"incomplete"
return null}function w(e){return e===f||e===d||e===p}function k(e,t){if(t)return w(t)
return"number"===typeof e||h(e)}function T(){return s.t("Excused")}function j(e){return s.n(Object(r["a"])(e,2),{precision:2,strip_insignificant_zeros:true})}function E(e,t){const n=t.pointsPossible?Object(l["c"])(e,t.pointsPossible):e
return s.n(Object(r["a"])(n,2),{percentage:true,precision:2,strip_insignificant_zeros:true})}function y(e,t,n){if(n.pointsPossible){const t=Object(l["c"])(e,n.pointsPossible)
return Object(a["d"])(t,n.gradingScheme)}return null!=t?t:Object(a["d"])(e,n.gradingScheme)}function N(e,t,n){let o=false
o=n.pointsPossible?e>0:m.includes(t)
return o?s.t("Complete"):s.t("Incomplete")}function z(e,t={}){if(e.excused)return T()
if(null==e.grade)return null!=t.defaultValue?t.defaultValue:b
return e.grade}const F={formatGrade(e,t={}){let n=e
if(null==e||""===e)return"defaultValue"in t?t.defaultValue:e
if(x(e))return T()
let o=F.parseGrade(e,t)
if(k(o,t.gradingType))if(h(o,t.gradingType)){o=P(o)
n="complete"===o?s.t("complete"):s.t("incomplete")}else{const c=Object(r["a"])(o,t.precision||2)
n=s.n(c,{percentage:g(e,t.gradingType)})}t.gradingType===f&&t.formatType===u&&(n=v(e,t.pointsPossible))
return n},delocalizeGrade(e){if(void 0===e||null===e||"string"!==typeof e)return e
const t=i["a"].parse(e.replace("%",""))
if(isNaN(t))return e
return t+(/%/g.test(e)?"%":"")},parseGrade(e,t={}){let n
if(null==e||""===e||"number"===typeof e)return e
const o=e.replace("%","")
n=!("delocalize"in t)||t.delocalize||isNaN(o)?i["a"].parse(o):parseFloat(o)
if(isNaN(n))return e
return n},excused:T,isExcused:x,formatGradeInfo:z,formatPointsOutOf:v,formatSubmissionGrade(e,t={version:"final"}){if(e.excused)return T()
...
case"gradingScheme":return y(n,o,t)
case"passFail":return N(n,o,t)
default:return j(n)}},UNGRADED:b}
t["a"]=F},FdVj:function(e,t,n){"use strict"
var o=n("qJBq")
var c=n.n(o)
var s=n("HGxv")
...
t["a"]=r},nc0P:function(e,t,n){var o;(function(c){"use strict"
var s,r=20,i=1,l=1e6,a=1e6,f=-7,d=21,p="[big.js] ",u=p+"Invalid ",m=u+"decimal places",_=u+"rounding mode",b=p+"Division by zero",h={},g=void 0,x=/^-?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i
function v(){function e(t){var n=this
if(!(n instanceof e))return t===g?v():new e(t)
if(t instanceof e){n.s=t.s
n.e=t.e
n.c=t.c.slice()}else P(n,t)
...
e.PE=d
e.version="5.2.2"
return e}function P(e,t){var n,o,c
if(0===t&&1/t<0)t="-0"
else if(!x.test(t+=""))throw Error(u+"number")
...
e.c=[]
for(n=0;o<=c;)e.c[n++]=+t.charAt(o++)}return e}function w(e,t,n,o){var c=e.c,s=e.e+t+1
...
var i,a,f,d,p,u=c.slice(),_=i=c.length,h=o.length,x=o.slice(0,i),v=x.length,P=e,k=P.c=[],T=0,j=r+(P.e=t.e-e.e)+1
P.s=s
s=j<0?0:j
u.unshift(0)
for(;v++<i;)x.push(0)
do{for(f=0;f<10;f++){if(i!=(v=x.length))d=i>v?1:-1
else for(p=-1,d=0;++p<i;)if(c[p]!=x[p]){d=c[p]>x[p]?1:-1
break}if(!(d<0))break
for(a=v==i?c:u;v;){if(x[--v]<a[v]){p=v
for(;p&&!x[--p];)x[p]=9;--x[p]
x[v]+=10}x[v]-=a[v]}for(;!x[0];)x.shift()}k[T++]=d?f:++f
x[0]&&d?x[v]=o[_]||0:x=[o[_]]}while((_++<h||x[0]!==g)&&s--)
if(!k[0]&&1!=T){k.shift()
P.e--}T>j&&w(P,r,n.RM,x[0]!==g)
return P}
...
s=v()
s["default"]=s.Big=s
o=function(){return s}.call(t,n,t,e),void 0!==o&&(e.exports=o)})()},qJBq:function(e,t){(function(){var t,n,o
o=[]
t={}
...
e.exports.factoryReset()}).call(this)},xvQv:function(e,t,n){"use strict"
n.d(t,"a",(function(){return s}))
var o=n("nc0P")
var c=n.n(o)
function s(e,t=0){try{return parseFloat(c()(e).round(t),10)}catch(e){return NaN}}s.DEFAULT=2}}])

//# sourceMappingURL=49-c-9bea314320.js.map